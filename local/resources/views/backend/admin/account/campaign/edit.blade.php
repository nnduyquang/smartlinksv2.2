...
@section('container')
    ...
    {!! Form::model($campaign,array('route' => ['campaign.update',$campaign->id],'method'=>'PATCH')) !!}
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
            <button id="btnDanhMuc" type="submit" class="btn btn-primary">Cập Nhật Chiến Dịch</button>
        </div>
    </div>
